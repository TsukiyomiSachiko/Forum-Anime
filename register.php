	...
	<div class="register_container">
		...
		<h1 class="register_h1">Make your account here</h1><hr/><br>
			<form method="post" action="confirm.php">
				...
				<label class="register_label">Email adress: </label><br>
				<input class="register_input" type="text" name="email"><br>

				<label class="register_label">First name: </label><br>
				<input class="register_input" type="text" name="first_name"><br>

				<label class="register_label">Last name: </label><br>
				<input class="register_input" type="text" name="last_name"><br>

				<label class="register_label">Age: </label><br>
				<select class="register_select" name="age">
